...
#_(def store (kons/add-hitchhiker-tree-handlers
            (<?? (new-fs-store "/tmp/datascript-play"))))


#_(def backend (kons/->KonserveBackend store))

#_(defn store-db [db backend]
